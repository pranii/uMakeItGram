...
export const ending_src = [
  "../../" + environment.assetUrl + "/final/ending/goodEnding.jpg",
  "../../" + environment.assetUrl + "/final/ending/badEnding.jpg",
  "../../" + environment.assetUrl + "/final/ending/ending.jpg",
]
...
export const path_fashion: Map<number, ActionTypes> = new Map([
  [0,   
    {
      image: "../../" + environment.assetUrl + "/fi/Rdesktop.png",
  ...
  [1,
    {
      image: "./../" + environment.assetUrl + "/fi/branded.png",
  ...
  [2,
    {
      image: "./../" + environment.assetUrl + "/final/Bedroom.png",
      text: "",
      decision: [
        {
          id: 0,
  ...
  [4,
    {
      image: "../../" + environment.assetUrl + "/final/LivingRoom.png",
  ...
  [7,
    {
      image: "../../" + environment.assetUrl + "/fi/randoo.png",
  ...
  [10,
    {
      image: "../../" + environment.assetUrl + "/fi/chilliflock.png",
  ...
  [11,
    {
      image: "../../" + environment.assetUrl + "/final/MakeItGram Open.png",
  ...
  [12,
    {
      image: "../../" + environment.assetUrl + "/final/doorclosed.png",
      text: "",
      nextStep: 13,
      type: ActionType.ACTION
    }
  ...
  [13,
    {
      image: "../../" + environment.assetUrl + "/final/dooropen.png",
      text: "",
      nextStep: 14,
      type: ActionType.ACTION
    }
  ...
  [14,
    {
      image: "../../" + environment.assetUrl + "/final/paket.png",
      text: "",
      nextStep: 15,
      type: ActionType.ACTION
    }
  ...
  [19,
    {
      image: "../../" + environment.assetUrl + "/fi/Rr.png",
  ...
  [22,
    {
      image: "../../" + environment.assetUrl + "/fi/Rvertrag.png",
  ...
  [23,
    {
      image: "../../" + environment.assetUrl + "/fi/RUVertrag.png",
  ...
  [40,
    {
      image: "../../" + environment.assetUrl + "/fi/Rdsktpt.png",
  ...
  [42,
    {
      image: "../../" + environment.assetUrl + "/fi/reels.png",
      text: "ELIZA: Perfekt, hier sind weitere Challenges, die du machen kannst:",
      decision: [
        {
          id: 0,
  ...
  [44,
    {
      image: "../../" + environment.assetUrl + "/final/HomeScreen.png",
...
text: "ELIZA: Genug für heute. Du musst bestimmt schon müde sein. Warum legst du dich nicht hin? Auf den weiteren Verlauf hast du sowieso keinen Einfluss mehr. Dafür ist deine Community verantwortlich.",
  ...
  [52,
    {
      image: "../../" + environment.assetUrl + "/fi/Dsktp.png",
...
text: "ELIZA: Übrigens kam dein Werbepost auch bei TEAPOT sehr gut an. Sie sind an einer längerfristigen Kooperation interessiert und zahlen dir 2000€ pro Beitrag, aber nur, wenn du sie regelmäßig bewirbst. Was hältst du davon?",
  ...
  [67,
    {
      image: "../../" + environment.assetUrl + "/fi/titi.png",
  ...
  [75,
    {
      image: "../../" + environment.assetUrl + "/final/Bedroom.pngg",
  ...
  [84,
    {
      image: "../../" + environment.assetUrl + "/final/Chats/Luisa1/1.png",
  ...
  [90,
    {
      image: "../../" + environment.assetUrl + "/final/Chats/Luisa1/2.png",
      text: "",
      nextStep: 91,
      type: ActionType.ACTION
    }
  ...
  [91,
    {
      image: "../../" + environment.assetUrl + "/final/Chats/Luisa1/3.png",
      text: "",
      nextStep: 94,
      type: ActionType.ACTION
    }
  ...
  [100,
    {
      image: "../../" + environment.assetUrl + "/fi/Png.png",
  ...
  [112,
    {
      image: "../../" + environment.assetUrl + "/final/Koffer.png",
      text: "",
      nextStep: 114,
      type: ActionType.ACTION
    }
  ...
  [114,
    {
      image: "../../" + environment.assetUrl + "/fi/Windw.png",
      text: "",
      nextStep: 115,
      type: ActionType.ACTION
    }
  ...
  [119,
    {
      image: "../../" + environment.assetUrl + "/fi/Poll.png",
  ...
  [123,
    {
      image: "../../" + environment.assetUrl + "/final/Chats/Luisa2/5.png",
      text: "",
      nextStep: 124,
      type: ActionType.ACTION
    }
  ...
  [124,
    {
      image: "../../" + environment.assetUrl + "/final/Chats/Luisa2/8.png",
      text: "",
      nextStep: 125,
      type: ActionType.ACTION
    }
  ...
  [125,
    {
      image: "../../" + environment.assetUrl + "/final/Chats/Luisa2/9.png",
      text: "",
      nextStep: 126,
      type: ActionType.ACTION
    }
  ...
  [126,
    {
      image: "../../" + environment.assetUrl + "/final/Chats/Luisa2/10.png",
      text: "",
      nextStep: 128,
      type: ActionType.ACTION
    }
  ...
  [128,
    {
      image: "../../" + environment.assetUrl + "/fi/RrDesktop.png",
 ...
 */
  ...
  /*136*/[134,
    {
      image: "../../" + environment.assetUrl + "/final/VertragohnEUnterschrift.png",
  ...
  [141,
    {
      image: "../../" + environment.assetUrl + "/final/Vertrag.png",
 ...
 */
  ...
  [151,
    {
      image: "../../" + environment.assetUrl + "/fi/randoo (1).png",
  ...
  [161,
    {
      image: "../../" + environment.assetUrl + "/final/Window.png",
  ...
  [163,
    {
      image: "../../" + environment.assetUrl + "/fi/randoo (2).png",
      text: "Zwei Wochen später...",
      type: ActionType.POPUP,
      nextStep: 164
    }
  ...
  [164,
    {
      image: "../../" + environment.assetUrl + "/fi/bangladesh.png",
  ...
  [177,
    {
      image: "../../" + environment.assetUrl + "/fi/rando.png",
  ...
  [187,
    {
      image: "../../" + environment.assetUrl + "/desktop.png",
  ...
  [191,
    {
      image: "../../" + environment.assetUrl + "/final/Party.png",
  ...
  [196,
    {
      image: "../../" + environment.assetUrl + "/final/Parttxy.png",
      text: "",
      nextStep: 200,
      type: ActionType.ACTION
    }
  ...
  [200,
    {
      image: "../../" + environment.assetUrl + "/final/Chats/Eliza/11.png",
      text: "",
      nextStep: 201,
      type: ActionType.ACTION
    }
  ...
  [201,
    {
      image: "../../" + environment.assetUrl + "/final/Chats/Eliza/12.png",
      text: "",
      nextStep: 202,
      type: ActionType.ACTION
    }
  ...
  [203,
    {
      image: "../../" + environment.assetUrl + "/final/Chats/Eliza/13.png",
      text: "",
      nextStep: 204,
      type: ActionType.ACTION
    }
  ...
  [204,
    {
      image: "../../" + environment.assetUrl + "/final/Chats/Eliza/14.png",
      text: "",
      nextStep: 205,
      type: ActionType.ACTION
    }
  ...
  [205,
    {
      image: "../../" + environment.assetUrl + "/final/Chats/Eliza/15.png",
      text: "",
      nextStep: 206,
      type: ActionType.ACTION
    }
  ...
  [206,
    {
      image: "../../" + environment.assetUrl + "/final/Chats/Eliza/16.png",
      text: "",
      nextStep: 1000,
      type: ActionType.ACTION
    }
